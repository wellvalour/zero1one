...
public class AuthenticationManager {
	...
	/**
	 * Speichert neues Passwort (Hashwert) zu User ab. Nutzername und Berechtigung
	 * müssen trotzdem gesetzt sein.
	 * 
	 * @param user
	 */
	...
	/**
	 * Speichert neue Berechtigung zu User ab. Nutzername und Passwort (Hashwert)
	 * müssen trotzdem gesetzt sein.
	 * 
	 * @param user
	 */
